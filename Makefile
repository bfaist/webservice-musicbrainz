# This Makefile is for the WebService::MusicBrainz extension to perl.
#
...
#     EXE_FILES => []
#     INSTALLDIRS => q[site]
#     NAME => q[WebService::MusicBrainz]
#     PL_FILES => {  }
#     PREREQ_PM => { URI=>q[1.35], Test::More=>q[0.88], Class::Accessor=>q[0.30], XML::LibXML=>q[1.63], LWP::UserAgent=>q[2.0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/WebService/MusicBrainz.pm]
...
NAME_SYM = WebService_MusicBrainz
VERSION = 1.0
...
MAKE = make
FULLEXT = WebService/MusicBrainz
BASEEXT = MusicBrainz
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/WebService/MusicBrainz.pm \
	lib/WebService/MusicBrainz/Request.pm \
	lib/WebService/MusicBrainz/Response.pm
...
TO_INST_PM = lib/WebService/MusicBrainz.pm \
	lib/WebService/MusicBrainz/Request.pm \
	lib/WebService/MusicBrainz/Response.pm

PM_TO_BLIB = lib/WebService/MusicBrainz.pm \
	blib/lib/WebService/MusicBrainz.pm \
	lib/WebService/MusicBrainz/Request.pm \
	blib/lib/WebService/MusicBrainz/Request.pm \
	lib/WebService/MusicBrainz/Response.pm \
	blib/lib/WebService/MusicBrainz/Response.pm
...
DISTNAME = WebService-MusicBrainz
DISTVNAME = WebService-MusicBrainz-1.0
...
manifypods : pure_all  \
	lib/WebService/MusicBrainz/Response.pm \
	lib/WebService/MusicBrainz/Request.pm \
	lib/WebService/MusicBrainz.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/WebService/MusicBrainz/Response.pm $(INST_MAN3DIR)/WebService::MusicBrainz::Response.$(MAN3EXT) \
	  lib/WebService/MusicBrainz/Request.pm $(INST_MAN3DIR)/WebService::MusicBrainz::Request.$(MAN3EXT) \
	  lib/WebService/MusicBrainz.pm $(INST_MAN3DIR)/WebService::MusicBrainz.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: WebService-MusicBrainz' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "WebService-MusicBrainz",' >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/WebService/MusicBrainz.pm blib/lib/WebService/MusicBrainz.pm \
	  lib/WebService/MusicBrainz/Request.pm blib/lib/WebService/MusicBrainz/Request.pm \
	  lib/WebService/MusicBrainz/Response.pm blib/lib/WebService/MusicBrainz/Response.pm 
