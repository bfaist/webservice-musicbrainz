package WebService::MusicBrainz::ReleaseGroup;
...
sub _init {
   ...
   $q->set_url_params(qw/mbid title artist artistid releasetypes limit offset query/);
   $q->set_inc_params(qw/artist releases/);
